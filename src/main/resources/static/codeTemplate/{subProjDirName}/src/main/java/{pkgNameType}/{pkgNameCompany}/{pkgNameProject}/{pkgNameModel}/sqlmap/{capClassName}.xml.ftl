...
<mapper namespace="${fullPkgModel}.dao.${capClassName}Dao">
	...
	<!-- ==============================基础操作======================================= -->
	<!--根据条件得到列表 -->
	<select id="selectList" parameterType="${fullPkgModel}.pojo.${capClassName}Pojo" resultType="${fullPkgModel}.pojo.${capClassName}Pojo">
		<![CDATA[ 
	...
	<!--根据id得到记录 -->
	<select id="selectUnique" parameterType="${fullPkgModel}.pojo.${capClassName}Pojo" resultType="${fullPkgModel}.pojo.${capClassName}Pojo">
		<![CDATA[ 
			SELECT ${selectListStr}
